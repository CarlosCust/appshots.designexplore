export const MobileMenuDropdown = () => {
  return (
    <div className="absolute right-0 top-full mt-2 w-48 bg-white rounded-xl shadow-lg border border-gray-200 p-4 z-50">
      <div className="flex flex-col gap-3">
        <a href="#" className="text-sm text-neutral-700 hover:text-black transition-colors">Resources</a>
        <a href="#" className="text-sm text-neutral-700 hover:text-black transition-colors">Pricing</a>
