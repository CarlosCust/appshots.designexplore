...
const appsData: Record<string, AppData> = {
  "period-tracker": {
    ...
    logo: "https://c.animaapp.com/mm0wesngkLOWmr/img/app-logo.png",
    formFactor: "iPhone 12",
    platform: "iOS",
    rating: "4.5/5",
    category: "Health & Fitness",
    screenshots: [
      "https://c.animaapp.com/mm0wesngkLOWmr/img/pinkllama---app-screenshot-1.png",
      "https://c.animaapp.com/mm0wesngkLOWmr/img/pinkllama---app-screenshot-2.png",
      "https://c.animaapp.com/mm0wesngkLOWmr/img/pinkllama---app-screenshot-3.png",
      "https://c.animaapp.com/mm0wesngkLOWmr/img/pinkllama---app-screenshot-4.png",
      "https://c.animaapp.com/mm0wesngkLOWmr/img/pinkllama---app-screenshot-5.png",
      "https://c.animaapp.com/mm0wesngkLOWmr/img/pinkllama---app-screenshot-6.png",
    ],
    totalScreens: 67,
  },
  "wikipedia": {
    name: "Wikipedia — The Free Encyclopedia",
    logo: "https://firebasestorage.googleapis.com/v0/b/appshots-design.appspot.com/o/appshots%2Fwikipedia%2Fapp-icon.jpg?alt=media&token=47dd010f-eb2c-444f-8f7e-477c1ddbcbf0",
    formFactor: "iPhone 12",
    platform: "iOS",
    rating: "4.7/5",
    category: "Reference",
    screenshots: [
      "https://picsum.photos/seed/wikipedia1/400/800",
      "https://picsum.photos/seed/wikipedia2/400/800",
      "https://picsum.photos/seed/wikipedia3/400/800",
      "https://picsum.photos/seed/wikipedia4/400/800",
      "https://picsum.photos/seed/wikipedia5/400/800",
      "https://picsum.photos/seed/wikipedia6/400/800",
    ],
    totalScreens: 42,
  },
  "duolingo-math": {
    name: "Duolingo Math — Lessons & Brain Training",
    logo: "https://firebasestorage.googleapis.com/v0/b/appshots-design.appspot.com/o/appshots%2Fduolingo_math%2Fapp-icon.jpg?alt=media&token=5f3a5ea1-4d02-4004-968d-ea9291869d4a",
    formFactor: "iPhone 12",
    platform: "iOS",
    rating: "4.6/5",
    category: "Education",
    screenshots: [
      "https://picsum.photos/seed/duolingo-math1/400/800",
      "https://picsum.photos/seed/duolingo-math2/400/800",
      "https://picsum.photos/seed/duolingo-math3/400/800",
      "https://picsum.photos/seed/duolingo-math4/400/800",
      "https://picsum.photos/seed/duolingo-math5/400/800",
      "https://picsum.photos/seed/duolingo-math6/400/800",
    ],
    totalScreens: 38,
  },
  "onefootball": {
    name: "OneFootball — Soccer News & Scores",
    logo: "https://firebasestorage.googleapis.com/v0/b/appshots-design.appspot.com/o/appshots%2Fonefootball%2Fapp-icon.jpg?alt=media&token=e1e9fbff-ae69-438b-b9e7-5eebbd5fa3e3",
    formFactor: "iPhone 12",
    platform: "iOS",
    rating: "4.3/5",
    category: "Sports",
    screenshots: [
      "https://picsum.photos/seed/onefootball1/400/800",
      "https://picsum.photos/seed/onefootball2/400/800",
      "https://picsum.photos/seed/onefootball3/400/800",
      "https://picsum.photos/seed/onefootball4/400/800",
      "https://picsum.photos/seed/onefootball5/400/800",
      "https://picsum.photos/seed/onefootball6/400/800",
    ],
    totalScreens: 55,
  },
  "uber-eats": {
    name: "Uber Eats — Fresh Grocery & Delivery",
    logo: "https://firebasestorage.googleapis.com/v0/b/appshots-design.appspot.com/o/appshots%2Fuber_eats%2Fapp-icon.webp?alt=media&token=05a87480-59f0-49da-bd6f-4ad23a7d2410",
    formFactor: "iPhone 12",
    platform: "iOS",
    rating: "4.2/5",
    category: "Food & Drink",
    screenshots: [
      "https://picsum.photos/seed/uber-eats1/400/800",
      "https://picsum.photos/seed/uber-eats2/400/800",
      "https://picsum.photos/seed/uber-eats3/400/800",
      "https://picsum.photos/seed/uber-eats4/400/800",
      "https://picsum.photos/seed/uber-eats5/400/800",
      "https://picsum.photos/seed/uber-eats6/400/800",
    ],
    totalScreens: 91,
  },
  "quora": {
    name: "Quora — Ask Questions, Get Answers",
    logo: "https://firebasestorage.googleapis.com/v0/b/appshots-design.appspot.com/o/appshots%2Fquora%2Fapp-icon.jpg?alt=media&token=12dbc974-d1ab-4fb6-92d1-84a51aa294c3",
    formFactor: "iPhone 12",
    platform: "iOS",
    rating: "4.1/5",
    category: "Social",
    screenshots: [
      "https://picsum.photos/seed/quora1/400/800",
      "https://picsum.photos/seed/quora2/400/800",
      "https://picsum.photos/seed/quora3/400/800",
      "https://picsum.photos/seed/quora4/400/800",
      "https://picsum.photos/seed/quora5/400/800",
      "https://picsum.photos/seed/quora6/400/800",
    ],
    totalScreens: 29,
  },
};
...
const getAppData = (appId: string): AppData => {
  ...
  return {
    name,
    logo: `https://picsum.photos/seed/${appId}-logo/88/88`,
    formFactor: "iPhone 12",
    platform: "iOS",
    rating: "4.5/5",
    category: "Apps",
    screenshots: Array.from({ length: 6 }, (_, i) => `https://picsum.photos/seed/${appId}${i + 1}/400/800`),
    totalScreens: 10,
  };
};
